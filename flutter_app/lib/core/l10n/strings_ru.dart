const Map<String, String> stringsRu = {
  ...
  'booking.info':
      'Забронируйте место и приходите вовремя. У вас есть 15 минут после начала брони. Если не придёте — бронь автоматически отменится.',
  'booking.club': 'Клуб',
  ...
  'freeze.desc':
      'Нажмите на дни в календаре, чтобы заморозить или разморозить. Дата окончания подписки сдвигается на каждый замороженный день.',
  ...
  'plans.desc':
      'Выберите тариф и оплатите удобным способом. Подписка будет активирована в течение 30 минут.',
  ...
  'pay.after_transfer_note':
      'После перевода нажмите «Я оплатил» и заполните короткую форму. Мы активируем подписку в течение 30 минут.',
  'pay.i_paid': 'Я оплатил',
  'pay.confirm_title': 'Подтверждение оплаты',
  'pay.confirm_desc':
      'Заполните форму, чтобы мы могли проверить платёж и активировать подписку.',
  ...
  'pay.request_sent_desc':
      'Мы проверим платёж и активируем вашу подписку в течение 30 минут (в рабочие часы 09:00–22:00).\n\nВы получите уведомление, когда подписка будет активна.',
  ...
  'gift.share_text':
      'Привет! Дарю тебе подписку PlayPass. Активируй код: {code} в приложении!',
  ...
  'faq.a2':
      'Да, вы можете заморозить до {n} дней в месяц. Выберите конкретные дни в календаре через раздел Профиль.',
  ...
  'faq.a6':
      'Пригласите друга по реферальному коду и получите +{n} часа к подписке.',
};
